...
public class SaareActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(SaareActivity.this);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetSaree(ed_from.getText().toString(), ed_to.getText().toString());
            }
        });
    }

    private void GetSaree(final String from, String to) {
        ...
        Call<List<ProductModel>> call = services.ProductDetail("saree", from, to);
        ...
        call.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                AndroidListAdapter androidListAdapter = new AndroidListAdapter(SaareActivity.this, prodlist);

                ListView androidListView = (ListView) findViewById(R.id.list_saree);

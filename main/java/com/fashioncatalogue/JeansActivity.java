...
public class JeansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(JeansActivity.this);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetJeans(ed_from.getText().toString(),ed_to.getText().toString());
            }
        });

    }

    private void GetJeans(final String from, String to) {
        ...
        Call<List<ProductModel>> call = services.ProductDetail("Jeans", from, to);
        ...
        call.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                AndroidListAdapter androidListAdapter = new AndroidListAdapter(JeansActivity.this, prodlist);

                ListView androidListView = (ListView) findViewById(R.id.list_jeans);

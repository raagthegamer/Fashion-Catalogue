...
public class KameezActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kameez);

        pd = new ProgressDialog(KameezActivity.this);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetKameez(ed_from.getText().toString(),ed_to.getText().toString());
            }
        });
    }

    private void GetKameez(final String from, String to) {
        ...
        Call<List<ProductModel>> call = services.ProductDetail("Kameez", from, to);
        ...
        call.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                AndroidListAdapter androidListAdapter = new AndroidListAdapter(KameezActivity.this, prodlist);

                ListView androidListView = (ListView) findViewById(R.id.list_kameez);

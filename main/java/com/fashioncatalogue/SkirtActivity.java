...
public class SkirtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(SkirtActivity.this);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetSkirt(ed_from.getText().toString(),ed_to.getText().toString());
            }
        });

    }

    private void GetSkirt(final String from, String to) {
        ...
        Call<List<ProductModel>> call = services.ProductDetail("Skirt", from, to);
        ...
        call.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                AndroidListAdapter androidListAdapter = new AndroidListAdapter(SkirtActivity.this, prodlist);

                ListView androidListView = (ListView) findViewById(R.id.list_skirt);

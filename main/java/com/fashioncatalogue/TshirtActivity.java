...
public class TshirtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(TshirtActivity.this);
        ...
        btn_filter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GetTshirt(ed_from.getText().toString(),ed_to.getText().toString());
            }
        });

    }

    private void GetTshirt(final String from, String to) {
        ...
        Call<List<ProductModel>> call = services.ProductDetail("Tshirt", from, to);
        call.enqueue(new Callback<List<ProductModel>>() {
            ...
            public void onResponse(Call<List<ProductModel>> call, Response<List<ProductModel>> response) {
                ...
                AndroidListAdapter androidListAdapter = new AndroidListAdapter(TshirtActivity.this, prodlist);

                ListView androidListView = (ListView) findViewById(R.id.list_tshirt);
